...
class Chat{
	...
	public static function gravatarFromHash($hash, $size=23){
		...
		//return 'https://api.adorable.io/avatars/192/' . $hash;
		return 'https://robohash.org/'.$hash.'?set=set4&size=43x43&bgset=bg1';
	}
}
