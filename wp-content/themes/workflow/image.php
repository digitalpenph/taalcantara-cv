		...
		<div id="inner-content" class=" cf">
			...
			*/
			...
			<div id="blog" class="divider-posted">
				...
				<strong><?php the_title(); ?></strong> <?php printf( __( 'Posted on <time class="updated" datetime="%1$s" pubdate>%2$s</time>', 'workflow' ), get_the_time('Y-m-j'), get_the_time(get_option('date_format'))  ); ?>
